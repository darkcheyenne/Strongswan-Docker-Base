...
echo "  🚀 Erstellen von Image fuer Strownswan 5.9.9"
docker build --pull -t darkcheyenne/strongswan-cosmic_base:5.9.9 -t darkcheyenne/strongswan-cosmic_base:latest .
...
echo "  📡 Upload von Image fuer Strownswan 5.9.9"
docker push darkcheyenne/strongswan-cosmic_base:5.9.9
